...
function NavItem({ item, i }: { item: SiteNavigationElement; i: number }) {
  ...
  return (
    ...
    >
      {i === 0
        ? (
          <a href={url} class="group-hover:underline text-sm font-black">
            {name}
          </a>
        )
        : (
          <a href={url} class="group-hover:underline text-sm font-normal">
            {name}
          </a>
        )}
